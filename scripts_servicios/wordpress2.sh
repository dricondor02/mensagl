...
$_SERVER["HTTP_HOST"] = "wordpress226.duckdns.org";\
$_SERVER["REMOTE_ADDR"] = "wordpress226.duckdns.org";\
$_SERVER["SERVER_ADDR"] = "wordpress226.duckdns.org";\
' /var/www/html/wp-config.php


sudo scp -i clave.pem -o StrictHostKeyChecking=no ubuntu@10.226.1.10:/home/ubuntu/certwordpress/* /home/ubuntu/
