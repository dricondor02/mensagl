#!/bin/bash
#cambiar dominios
wordpress=wordpress226
openfire=openfire226
#cambiar token
token=defc7e03-0d2c-4852-b43d-17590308776d
#cambiar alumno
alumno=dricondor02
...
while [ ! -e /etc/letsencrypt/live/wordpress226.duckdns.org ]; do
...
while [ ! -e /etc/letsencrypt/live/openfire226.duckdns.org ]; do
...
while [ ! -e /etc/letsencrypt/live/openfire226.duckdns.org-0001 ]; do
